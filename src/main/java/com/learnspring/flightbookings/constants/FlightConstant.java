package com.learnspring.flightbookings.constants;
...
public class FlightConstant {
    ...
    public static final String domesticFlight = "DOMESTIC";
    public static final String STATUS_201 = "201";
    public static final String MESSAGE_201="Flight Information Added Successfully";
